...
">A ĐẠT</span> <span>STORE</span> </a>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <li style="padding: 25px; font-size: 18px; margin-left: 30px;">
                        <div class="image">
                            <img src="https://pickaface.net/gallery/avatar/20130319_083314_1174_admin.png" class="img-circle elevation-2" style ="width: 100px" alt="User Image">
                            </div>
                            <div class="info">
                            <a href="{{route('user.getedit',Auth::user()->id)}}" class="d-block">{{ Auth::user()->name }}</a>
                        </div>
                </li>
